...
func TestParse(t *testing.T) {
	testData := []struct {
		...
		{`ALTER TABLE t EXPERIMENTAL_REVERT TO AS OF SYSTEM TIME '-1s'`},
		{`ALTER TABLE t EXPERIMENTAL_REVERT TO AS OF SYSTEM TIME '-1s' CASCADE`},
		{`ALTER TABLE t EXPERIMENTAL_REVERT TO AS OF SYSTEM TIME '-1s' RESTRICT`},
		{`ALTER TABLE t EXPERIMENTAL_REVERT TO AS OF SYSTEM TIME '2016-01-01'`},
