...
// StatementReturnType implements the Statement interface.
func (*CreateTenantFromTenant) StatementReturnType() StatementReturnType { return Ack }

// StatementType implements the Statement interface.
func (*CreateTenantFromTenant) StatementType() StatementType { return TypeDCL }

// StatementTag returns a short string identifying the type of statement.
func (*CreateTenantFromTenant) StatementTag() string { return "CREATE VIRTUAL CLUSTER FROM" }
...
func (n *CreateTenantFromTenant) String() string              { return AsString(n) }
