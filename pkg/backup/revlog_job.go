...
//
// TODO(revlog): expose as a cluster setting / per-job knob.
...
//     call (no descriptor-driven filtering). TODO(revlog): consult
...
//
// TODO(revlog): once makeTenantSpanResolver narrows to descriptor-
...
func makeDescSpanResolver(codec keys.SQLCodec, details jobspb.BackupDetails) revlogjob.DescSpanResolver {
	return func(
